...
- Nuevo módulo llamado `agenda`. El cual va a mostrar en forma de tabla todas las citas del día, tanto las agendadas como los espacios sin reserva.
